...
static int ov5645_update_slave_id(struct ov5645 *sensor)
{
	...
	retval = ov5645_write_reg(0x3100, slave_id);
			...
			const struct i2c_device_id *id)
{
	...
	dev_info(dev, "ov5645_mipi_v2.c ov5640_probe(gpios allocated)\n");	
	...
	dev_info(dev, "ov5645_mipi_v2.c ov5640_probe(clk allocated)\n");	
	...
	ov5645_data.pix.pixelformat      = sensor->pix.pixelformat      = V4L2_PIX_FMT_YUYV;
	ov5645_data.pix.width            = sensor->pix.width            = 640;
	ov5645_data.pix.height           = sensor->pix.height           = 480;
	ov5645_data.streamcap.capability = sensor->streamcap.capability = V4L2_MODE_HIGHQUALITY | V4L2_CAP_TIMEPERFRAME;
	ov5645_data.streamcap.capturemode= sensor->streamcap.capturemode= 0;
	ov5645_data.streamcap.timeperframe.denominator = sensor->streamcap.timeperframe.denominator = DEFAULT_FPS;
	ov5645_data.streamcap.timeperframe.numerator = sensor->streamcap.timeperframe.numerator = 1;

	dev_info(dev, "ov5645_mipi_v2.c ov5640_probe(now enable regulator)\n");	
...
#endif
	dev_info(dev, "ov5645_mipi_v2.c ov5640_probe(read chipid...)\n");	
