...
static int mx6s_vidioc_g_ctrl(struct file *file, void *fh,struct v4l2_control *ctrl)
{
	struct mx6s_csi_dev *csi_dev = video_drvdata(file);
	struct v4l2_subdev *sd = csi_dev->sd;
...
static int mx6s_vidioc_s_ctrl(struct file *file, void *fh,struct v4l2_control *ctrl)
{
	struct mx6s_csi_dev *csi_dev = video_drvdata(file);
	struct v4l2_subdev *sd = csi_dev->sd;
