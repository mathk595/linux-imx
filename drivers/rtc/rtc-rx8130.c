// From https://github.com/jens-maus/RaspberryMatic/blob/master/buildroot-external/package/rx8130-rtc/kernel-modules/rtc_rx8130ce/rtc-rx8130.c
// Modified by H. Leenings at Scheidt-Bachmann.de
//======================================================================
...
static int rx8130_init_client(struct i2c_client *client, int *need_reset)
{
	...
	ctrl[2] |= RX8130_BIT_CTRL_BFVSEL1;
