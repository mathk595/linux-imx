...
static struct platform_driver pwm_backlight_legacy_driver = {
	.driver		= {
		.name		= "pwm-backlight-legacy",
...
module_platform_driver(pwm_backlight_legacy_driver);

MODULE_DESCRIPTION("PWM based Backlight Driver (Legacy)");
MODULE_LICENSE("GPL");
MODULE_ALIAS("platform:pwm-backlight_legacy");
